...
export const mockListings: any[] = [
  ...
  },
  {
    ...
    state: "active",
    creation_tsz: Math.floor(Date.now() / 1000) - 1728000,
    ending_timestamp: Math.floor(Date.now() / 1000) + 86400,
    original_creation_timestamp: Math.floor(Date.now() / 1000) - 1728000,
    last_modified_tsz: Math.floor(Date.now() / 1000) - 43200,
    price: {
      amount: 3599,
      divisor: 100,
      currency_code: "USD"
  ...
  },
  {
    ...
    state: "active",
    creation_tsz: Math.floor(Date.now() / 1000) - 864000,
    ending_timestamp: Math.floor(Date.now() / 1000) + 86400,
    original_creation_timestamp: Math.floor(Date.now() / 1000) - 864000,
    last_modified_tsz: Math.floor(Date.now() / 1000) - 21600,
    price: {
      amount: 4599,
      divisor: 100,
      currency_code: "USD"
